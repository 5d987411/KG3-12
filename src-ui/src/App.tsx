...
function App() {
  ...
  const [rpcUrl, setRpcUrl] = useState('https://api-tn12.kaspa.org');
  ...
  return (
    <div className="container">
      <header className="header">
        <h1>KaspaGraffiti</h1>
        <p>Post messages to the Kaspa blockchain (testnet-12)</p>
      </header>
      ...
      {activeTab === 'compose' && wallet && (
        <div className="card">
          ...
          <div className="form-group">
            <label>RPC URL (testnet-12)</label>
            <input
              type="text"
              value={rpcUrl}
              onChange={(e) => setRpcUrl(e.target.value)}
              placeholder="https://api-tn12.kaspa.org"
            />
          </div>
      ...
      {activeTab === 'status' && (wallet || hdWallet) && (
        <div className="card">
          ...
          <div className="wallet-info">
            ...
            <div className="wallet-info-item">
              <span className="wallet-info-label">Network</span>
              <span className="wallet-info-value">testnet-12</span>
            </div>
            <div className="wallet-info-item">
